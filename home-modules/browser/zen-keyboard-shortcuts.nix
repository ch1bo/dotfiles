# Extension module for zen-browser-flake to add keyboard shortcuts support
{ config, pkgs, lib, ... }:
    ...
    type = types.attrsOf (types.submodule {
      options = {
        keyboardShortcuts = mkOption {
          type = types.listOf shortcutModule;
          default = [ ];
          description = ''
        ...
        (profileName: profile:
          let
            ...
            updateScript = pkgs.writeShellScript "zen-shortcuts-update-${profileName}" ''
              ...
              PREFS_FILE="${config.home.homeDirectory}/${profilePath}/${profileName}/prefs.js"
              ...
              ${lib.optionalString (profile.keyboardShortcutsVersion != null) ''
